            ...
            <div class="row flexcss">
               <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                  <div class="about-box">
                     ...
                     <p>DAGANG LOKAL adalah startup yang memulai perjalanannya tahun 2020 dengan visi menjadi “oli” dari ekonomi eCommerce Indonesia.
                        <br>
                        <br>
            ...
            <div class="row flexcss">
               ...
               <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                  <div class="about-box">
                     ...
                     <b>Kecepatan</b>
                     <p>
                        Dengan staf terlatih dan sistem berbasis teknologi yang canggih, baik UMKM ataupun Advertiser dapat dengan mudah terhubung dengan Dagang Lokal
                     </p>
                     <br>
                     <b>Kepercayaan</b>
                     <p>
            ...
            <div class="row flexcss">
               <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                  <div class="about-box">
                     ...
                     <p>Sangat memudahkan kami sebagai seller. Praktis, dan kami bisa fokus ke marketingnya, yang brasa Waktu habis untuk packing dan kirim baran Serta weekeend pun masih bisa termina order dan Langsung kirim
                     </p>
                     <b>- Taman Store</b>
                     <br>
